...
export const CardBody = ({
  ...
  return (
    <div
      className={cn(
        "flex justify-center lg:h-[15rem] h-[5rem] w-96 [transform-style:preserve-3d]  [&>*]:[transform-style:preserve-3d]",
        className
      )}
...
export const CardItem = ({
  ...
  const handleAnimations = () => {
    ...
    if (isMouseEntered) {
      ref.current.style.transform = `translateX(${translateX}px) translateY(${translateY}px) translateZ(${translateZ}px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) rotateZ(${rotateZ}deg) scale(1.1)`;
    } else {
