export const ItemsContainer = () => {
  ...
  const PRODUCTS = [
    { text: "10/5C ấp 3 xã Đông Thạnh huyện Hóc Môn", link: "#" },
  ];
  const CONTACT = [
  ...
  return (
    <div className="mt-[19.5rem] grid bg-primaryBlack grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 ">
      <ul>
      ...
      <ul>
        <h1 className="mb-1 font-semibold text-white text-2xl">Địa Chỉ</h1>
        {PRODUCTS.map((link) => (
          <li key={link.text}>
            <a
              className="text-white hover:text-teal-400 duration-300
