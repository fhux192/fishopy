...
const AddressPage = () => {
  ...
  return (
    <div>
      <div className="mx-4">
        <div className="flex lg:pb-0 lg:mt-0  w-full justify-center whitespace-nowrap">
        ...
        <h2 className="font-bold mt-[0.5rem] lg:block lg:text-xl text-lg text-White">
          Trại cá Guppy Hóc Môn
        </h2>
